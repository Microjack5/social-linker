...
{
    class Help : InteractionModuleBase<SocketInteractionContext>
    {
        public async Task HelpMenu(SocketSlashCommand command)
        {
            ...
            if (channelSearch != null && channelSearch.User.Id != command.User.Id)
            {
                ...
                await Help_Menu.Help_Start((SocketTextChannel)command.Channel, (SocketGuildUser)command.User);
                return;
            }
