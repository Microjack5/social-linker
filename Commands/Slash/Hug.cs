...
{
    class Hug : InteractionModuleBase<SocketInteractionContext>
    {
        public async Task HugCommand(SocketSlashCommand command)
        {
        ...
        public static async void HugUser(SocketSlashCommand command, SocketUser command_target)
        {
        ...
        public static async void HugError(SocketSlashCommand command)
        {
        ...
        public static async void HugSelf(SocketSlashCommand command)
        {
            var user = command.User;
            var channel = command.Channel;
        ...
        public static async void HugBot(SocketSlashCommand command)
        {
            var user = command.User;
            var channel = command.Channel;
