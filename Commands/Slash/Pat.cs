...
{
    class Pat : InteractionModuleBase<SocketInteractionContext>
    {
        public async Task PatCommand(SocketSlashCommand command)
        {
        ...
        public static async void PatUser(SocketSlashCommand command, SocketUser command_target)
        {
        ...
        public static async void PatError(SocketSlashCommand command)
        {
        ...
        public static async void PatSelf(SocketSlashCommand command)
        {
            var user = command.User;
            var channel = command.Channel;
        ...
        public static async void PatBot(SocketSlashCommand command)
        {
            var user = command.User;
            var channel = command.Channel;
