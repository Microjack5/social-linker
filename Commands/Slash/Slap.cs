...
{
    class Slap : InteractionModuleBase<SocketInteractionContext>
    {
        public async Task SlapCommand(SocketSlashCommand command)
        {
            ...
            SlapUser(command, commandTarget);

            await Task.CompletedTask;
        }

        public static async void SlapUser(SocketSlashCommand command, SocketUser command_target)
        {
        ...
        public static async void SlapError(SocketSlashCommand command)
        {
        ...
        public static async void SlapSelf(SocketSlashCommand command)
        {
            var user = command.User;
            var channel = command.Channel;
        ...
        public static async void SlapBot(SocketSlashCommand command)
        {
            var user = command.User;
            var channel = command.Channel;
