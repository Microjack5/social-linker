...
{
    class Punch : InteractionModuleBase<SocketInteractionContext>
    {
        public async Task PunchCommand(SocketSlashCommand command)
        {
        ...
        public static async void PunchUser(SocketSlashCommand command, SocketUser command_target)
        {
        ...
        public static async void PunchError(SocketSlashCommand command)
        {
        ...
        public static async void PunchSelf(SocketSlashCommand command)
        {
            var user = command.User;
            var channel = command.Channel;
        ...
        public static async void PunchBot(SocketSlashCommand command)
        {
            var user = command.User;
            var channel = command.Channel;
