...
{
    public class Shared_TMS_Methods
    {
        public const int template_width = 1920;
        public const int template_height = 1080;

        public static async void RenderImage(SocketUser user, ISocketMessageChannel channel, string decor_id, List<string> rank_titles)
        {
            RestUserMessage loader = await channel.SendMessageAsync("", false, Shared_TMS_Methods.LoadingMessage().Build());

            var account = UserInfoClasses.GetAccount(user);

            Bitmap base_template = new Bitmap(template_width, template_height);

            Bitmap chara_bg = (Bitmap)System.Drawing.Image.FromFile($@"{AssetDirectoryConfig.assetDirectory.assetFolderPath}//Profile//StatusScreens//Decor//{decor_id}//chara_bg.png");
            Bitmap ui_overlay = (Bitmap)System.Drawing.Image.FromFile($@"{AssetDirectoryConfig.assetDirectory.assetFolderPath}//Profile//StatusScreens//Decor//{decor_id}//ui_overlay.png");
            ...
            using (Graphics graphics = Graphics.FromImage(base_template))
            {
                ...
                graphics.DrawImage(RenderFont(user, account, rank_titles), 0, 0, template_width, template_height);
        ...
        public static Bitmap RenderFont(SocketUser user, UserInfoFields account, List<string> rank_titles)
        {
            ...
            using (Graphics graphics = Graphics.FromImage(base_bitmap))
            {
                ...
                {
                    stringFormat.Alignment = StringAlignment.Near;
                    graphics.DrawString($"{Get_Class_Title(proficiency_rank, diligence_rank, expression_rank, rank_titles)}", neology_deco, Brushes.Black, class_title_window, stringFormat);
                }
        ...
        {
            Bitmap base_bitmap = new Bitmap(template_width, template_height);
            Bitmap stat_shine = (Bitmap)System.Drawing.Image.FromFile($@"{AssetDirectoryConfig.assetDirectory.assetFolderPath}//Profile//StatusScreens//Decor//Decor_TMS_Barry_1//stat_shine.png");
        ...
        // Utility
        public static string Get_Class_Title(int proficiency_rank, int diligence_rank, int expression_rank, List<string> rank_titles)
        {
            string title = "";
        ...
        public static Bitmap RenderPrestigeCounter(int level_resets)
        {
            ...
            Bitmap prestige_overlay = (Bitmap)System.Drawing.Image.FromFile($@"{AssetDirectoryConfig.assetDirectory.assetFolderPath}//Profile//StatusScreens//Decor//Decor_TMS_Barry_1//prestige_counter.png");

            // Copy the star to mark prestige to a bitmap.
            Bitmap prestige_star = (Bitmap)System.Drawing.Image.FromFile($@"{AssetDirectoryConfig.assetDirectory.assetFolderPath}//Profile//StatusScreens//Decor//Decor_TMS_Barry_1//star.png");
