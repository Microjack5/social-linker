...
namespace SocialLinker.Core.StatusScreens.Decor
{
    public static class Decor_TMS_Toma_1
    {
        ...
        public static async void RenderImage(SocketGuildUser user, ISocketMessageChannel channel)
        {
            ...
            Bitmap chara_bg = (Bitmap)System.Drawing.Image.FromFile($@"{AssetDirectoryConfig.assetDirectory.assetFolderPath}//Profile//StatusScreens//Decor//Decor_TMS_Toma_1//chara_bg.png");
            Bitmap ui_overlay = (Bitmap)System.Drawing.Image.FromFile($@"{AssetDirectoryConfig.assetDirectory.assetFolderPath}//Profile//StatusScreens//Decor//Decor_TMS_Toma_1//ui_overlay.png");
        ...
        {
            Bitmap base_bitmap = new Bitmap(template_width, template_height);
            Bitmap stat_shine = (Bitmap)System.Drawing.Image.FromFile($@"{AssetDirectoryConfig.assetDirectory.assetFolderPath}//Profile//StatusScreens//Decor//Decor_TMS_Toma_1//stat_shine.png");
        ...
        public static string Get_Class_Title(int proficiency_rank, int diligence_rank, int expression_rank)
        {
            ...
            switch (maxed_stat_count)
            {
                ...
                case 1:
                    title = "In the Kaiju Suit";
                    break;

                case 2:
                    title = "Pro Understudy";
                    break;
        ...
        public static Bitmap RenderPrestigeCounter(int level_resets)
        {
            ...
            Bitmap prestige_overlay = (Bitmap)System.Drawing.Image.FromFile($@"{AssetDirectoryConfig.assetDirectory.assetFolderPath}//Profile//StatusScreens//Decor//Decor_TMS_Toma_1//prestige_counter.png");

            // Copy the star to mark prestige to a bitmap.
            Bitmap prestige_star = (Bitmap)System.Drawing.Image.FromFile($@"{AssetDirectoryConfig.assetDirectory.assetFolderPath}//Profile//StatusScreens//Decor//Decor_TMS_Toma_1//star.png");
