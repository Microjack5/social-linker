...
namespace SocialLinker.Core.StatusScreens.Decor
{
    public static class Decor_TMS_Tiki_1
    {
        ...
        {
            Bitmap base_bitmap = new Bitmap(template_width, template_height);
            Bitmap stat_shine = (Bitmap)System.Drawing.Image.FromFile($@"{AssetDirectoryConfig.assetDirectory.assetFolderPath}//Profile//StatusScreens//Decor//Decor_TMS_Tiki_1//stat_shine.png");
        ...
        public static string Get_Class_Title(int proficiency_rank, int diligence_rank, int expression_rank)
        {
            ...
            {
                case 0:
                    title = "Mirage Uta-loid";
                    break;

                case 1:
                    title = "Troubled Uta-loid";
                    break;

                case 2:
                    title = "Virtual Empath";
                    break;

                case 3:
                    title = "Miracle Uta-loid";
                    break;
            }
        ...
        public static Bitmap RenderPrestigeCounter(int level_resets)
        {
            ...
            Bitmap prestige_overlay = (Bitmap)System.Drawing.Image.FromFile($@"{AssetDirectoryConfig.assetDirectory.assetFolderPath}//Profile//StatusScreens//Decor//Decor_TMS_Tiki_1//prestige_counter.png");

            // Copy the star to mark prestige to a bitmap.
            Bitmap prestige_star = (Bitmap)System.Drawing.Image.FromFile($@"{AssetDirectoryConfig.assetDirectory.assetFolderPath}//Profile//StatusScreens//Decor//Decor_TMS_Tiki_1//star.png");
