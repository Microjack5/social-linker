    ...
    public class Decor_Kasumi_1
    {
        public static async void RenderImage(SocketUser user, ISocketMessageChannel channel)
        {
            ...
            try
            {
                ...
                Bitmap base_layer = (Bitmap)System.Drawing.Image.FromFile($@"{AssetDirectoryConfig.assetDirectory.assetFolderPath}//Profile//StatusScreens//Decor//Decor_Kasumi_1//layer_1.png");

                // Copy the game textures to a bitmap
                Bitmap game_textures = (Bitmap)System.Drawing.Image.FromFile($@"{AssetDirectoryConfig.assetDirectory.assetFolderPath}//Profile//StatusScreens//Decor//Decor_Kasumi_1//layer_2.png");

                // Copy the graph decoration layer to a bitmap
                Bitmap graph_decoration = (Bitmap)System.Drawing.Image.FromFile($@"{AssetDirectoryConfig.assetDirectory.assetFolderPath}//Profile//StatusScreens//Decor//Decor_Kasumi_1//layer_3.png");

                // Copy the center of the graph to a bitmap
                Bitmap graph_center = (Bitmap)System.Drawing.Image.FromFile($@"{AssetDirectoryConfig.assetDirectory.assetFolderPath}//Profile//StatusScreens//Decor//Decor_Kasumi_1//layer_4.png");

                // Copy the star shading overlay to a bitmap
                Bitmap shading_overlay = (Bitmap)System.Drawing.Image.FromFile($@"{AssetDirectoryConfig.assetDirectory.assetFolderPath}//Profile//StatusScreens//Decor//Decor_Kasumi_1//layer_5.png");
                ...
                using (Graphics graphics = Graphics.FromImage(p5_template))
                {
                    ...
                    graphics.DrawImage(total_exp_bitmap, 251, 803, 476, 161);
        ...
        public static Bitmap RenderUserInfoBox()
        {
            ...
            using (Graphics graphics = Graphics.FromImage(new_bitmap))
            {
                ...
                System.Drawing.Color light_pink = System.Drawing.Color.FromArgb(252, 202, 205);
                SolidBrush pinkBrush = new SolidBrush(light_pink);
        ...
        public static Bitmap RenderUsername(string username)
        {
            ...
            using (Graphics graphics = Graphics.FromImage(username_bitmap))
            {
                ...
                System.Drawing.Color username_shadow_color = System.Drawing.Color.FromArgb(255, 130, 144);
