...
{
    public class Shared_P4AU_Methods
    {
        ...
        public static async void RenderImage(SocketUser user, ISocketMessageChannel channel, string decor_id)
        {
            ...
            try
            {
                ...
                Bitmap rotated_graph = RotateImage(RenderRadarChart(account, decor_id), -4);
                ...
                Bitmap username_layer = RenderUsername(display_name);

                Bitmap level_layer = RenderLevel(account, decor_id);
                ...
                using (Graphics graphics = Graphics.FromImage(base_template))
                {
                    ...
                    {
                        graphics.DrawImage(RenderPrestigeCounter(account.Level_Resets, decor_id), 0, 0, template_width, template_height);
                    }
                }
        ...
        public static Bitmap RenderRadarChart(UserInfoFields account, string decor_id)
        {
        ...
        public static Bitmap RenderLevel(UserInfoFields account, string decor_id)
        {
            Bitmap base_template = new Bitmap(template_width, template_height);
        ...
        public static Bitmap RenderPrestigeCounter(int level_resets, string decor_id)
        {
