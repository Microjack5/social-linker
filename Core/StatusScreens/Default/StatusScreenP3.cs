...
{
    internal static class StatusScreenP3
    {
        ...
        public static Bitmap RankBarBitmap()
        {
            ...
            using (Graphics graphics = Graphics.FromImage(new_bitmap))
            {
                ...
                graphics.Clear(System.Drawing.Color.FromArgb(252, 195, 75));
            }
        ...
        public static Bitmap RenderPrestigeCounter(int level_resets)
        {
            ...
            Bitmap prestige_overlay = (Bitmap)System.Drawing.Image.FromFile($@"{AssetDirectoryConfig.assetDirectory.assetFolderPath}//Profile//StatusScreens//Default//P3//prestige_counter.png");

            // Copy the star to mark prestige to a bitmap.
            Bitmap prestige_star = (Bitmap)System.Drawing.Image.FromFile($@"{AssetDirectoryConfig.assetDirectory.assetFolderPath}//Profile//StatusScreens//Default//P3//star.png");
        ...
        public static EmbedBuilder LoadingMessage()
        {
            ...
            {
                Name = "Loading Status...",
                IconUrl = "https://i.imgur.com/trtPflx.png"
            };
