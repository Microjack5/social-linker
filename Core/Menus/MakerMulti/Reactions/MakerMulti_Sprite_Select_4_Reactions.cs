...
namespace SocialLinker.Core.Menus.MakerMulti.Reactions
{
    class MakerMulti_Sprite_Select_4_Reactions
    {
        ...
        public static Task Nav_MakerMulti_Sprite_Select_4_Main_Received(SocketMessage message, MenuIdStructure menuSession)
        {
            ...
            if (MakerMulti_Sprite_Select_1_Reactions.Base_Sprite_Validity_Check(multimaker_session.MakerMultiCommand.Character_Data_4) == false)
            {
                // Stop the timeout timer associated with the menu.
                menuSession.MenuTimer.Stop();
            ...
            if ((multimaker_session.MakerMultiCommand.Character_Data_4.Base_Sprite == 0) && ((multimaker_session.MakerMultiCommand.Character_Data_4.Eye_Frame != default) || (multimaker_session.MakerMultiCommand.Character_Data_4.Mouth_Frame != default)))
            {
                // Stop the timeout timer associated with the menu.
                menuSession.MenuTimer.Stop();
            ...
            if (multimaker_session.MakerMultiCommand.Character_Data_4.Base_Sprite != 0)
            {
                var bustup = MakerMulti_Sprite_Select_1_Reactions.Bustup_Selection(menuSession, account, multimaker_session.MakerMultiCommand.Character_Data_4, 4); // Just a validity check
                ...
                multimaker_session.MakerMultiCommand.Character_Data_4.Bustup_Data = BustupDataMethods.Get_Bustup_Data(account, multimaker_session.MakerMultiCommand.Character_Data_4.Set_Data, multimaker_session.MakerMultiCommand.Character_Data_4);
            }
