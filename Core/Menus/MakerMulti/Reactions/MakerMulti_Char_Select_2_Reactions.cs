...
{
    class MakerMulti_Char_Select_2_Reactions
    {
        public static Task Nav_MakerMulti_Character_Select_2_Main(SocketReaction reaction, MenuIdStructure menuSession)
        {
        ...
        public static Task Nav_MakerMulti_Character_Select_2_Invalid_Character(SocketReaction reaction, MenuIdStructure menuSession)
        {
            if (reaction.Emote.Name == "↩️")
            {
                // Stop the timeout timer associated with the menu.
        ...
        public static Task Nav_MakerMulti_Character_Select_2_Error_Sprite(SocketReaction reaction, MenuIdStructure menuSession)
        {
            if (reaction.Emote.Name == "↩️")
            {
                // Stop the timeout timer associated with the menu.
        ...
        public static Task Nav_MakerMulti_Character_Select_2_Main_Received(SocketMessage message, MenuIdStructure menuSession)
        {
            ...
            if (sprite_set_info == null)
            {
                ...
                // Go to a new menu.
                _ = MakerMulti_Char_Select_2_Menu.MakerMulti_Character_Select_2_Invalid_Character(menuSession.User, menuSession.MenuMessage, input_string);
                return Task.CompletedTask;
            }

            multimaker_session.MakerMultiCommand.Character_Data_2.Set_Data = sprite_set_info;
