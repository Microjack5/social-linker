...
{
    class MakerMulti_Sprite_Select_1_Reactions
    {
        public static Task Nav_MakerMulti_Sprite_Select_1_Main(SocketReaction reaction, MenuIdStructure menuSession)
        {
        ...
        public static Task Nav_MakerMulti_Sprite_Select_1_Invalid_Base_Sprite(SocketReaction reaction, MenuIdStructure menuSession)
        {
            if (reaction.Emote.Name == "↩️")
            {
                // Stop the timeout timer associated with the menu.
        ...
        public static Task Nav_MakerMulti_Sprite_Select_1_Error_Too_Many_Animation_Frames(SocketReaction reaction, MenuIdStructure menuSession)
        {
            if (reaction.Emote.Name == "↩️")
            {
                // Stop the timeout timer associated with the menu.
        ...
        public static Task Nav_MakerMulti_Sprite_Select_1_Error_Non_Digit_In_Sprite_Number(SocketReaction reaction, MenuIdStructure menuSession)
        {
            if (reaction.Emote.Name == "↩️")
            {
                // Stop the timeout timer associated with the menu.
        ...
        public static Task Nav_MakerMulti_Sprite_Select_1_Error_Animation_Frame_With_Blank_Sprite(SocketReaction reaction, MenuIdStructure menuSession)
        {
            if (reaction.Emote.Name == "↩️")
            {
                // Stop the timeout timer associated with the menu.
        ...
        public static Task Nav_MakerMulti_Sprite_Select_1_Error_Eye_Frame_Not_Found(SocketReaction reaction, MenuIdStructure menuSession)
        {
            if (reaction.Emote.Name == "↩️")
            {
                // Stop the timeout timer associated with the menu.
        ...
        public static Task Nav_MakerMulti_Sprite_Select_1_Error_Mouth_Frame_Not_Found(SocketReaction reaction, MenuIdStructure menuSession)
        {
            if (reaction.Emote.Name == "↩️")
            {
                // Stop the timeout timer associated with the menu.
        ...
        public static Task Nav_MakerMulti_Sprite_Select_1_Main_Received(SocketMessage message, MenuIdStructure menuSession)
        {
            try
            {
                ...
                string result = Utility.Sprite_Number_Parser(input_string, multimaker_session, 1);
