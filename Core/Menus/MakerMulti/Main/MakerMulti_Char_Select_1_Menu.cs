...
{
    class MakerMulti_Char_Select_1_Menu
    {
        public static async Task MakerMulti_Character_Select_1_Main(SocketGuildUser user, RestUserMessage message)
        {
            ...
            embed.WithDescription("" +
                $"Type in the name of the first {OfficialSetMethods.AcronymToFullTitle(multimaker_session.MakerMultiCommand.Template)} character you'd like to use.\n" +
                $"\n" +
            ...
            menuSession.CurrentMenu = "MakerMulti_Character_Select_1_Main";
        ...
        public static async Task MakerMulti_Character_Select_1_Invalid_Character(SocketGuildUser user, RestUserMessage message, string user_input)
        {
            // Get the account information of the command's user.
            var account = UserInfoClasses.GetAccount(user);
