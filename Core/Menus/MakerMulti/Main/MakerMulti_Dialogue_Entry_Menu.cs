...
namespace SocialLinker.Core.Menus.MakerMulti.Main
{
    ...
    {
        public static async Task MakerMulti_Dialogue_Entry_Main(MenuIdStructure menuSession)
        {
            ...
            menuSession.CurrentMenu = "MakerMulti_Dialogue_Entry_Main";
        ...
        public static async Task MakerMulti_Dialogue_Details_Modal(SocketMessageComponent component)
        {
            // Get the account information of the command's user.
            if (component.Data.CustomId == "makermulti-dialogue-entry-modal-open")
            {
                try
                {
                    ...
                    .WithCustomId("makermulti-dialogue-entry-modal-submit")
