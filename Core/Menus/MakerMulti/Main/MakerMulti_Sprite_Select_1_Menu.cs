...
{
    class MakerMulti_Sprite_Select_1_Menu
    {
        public static async Task MakerMulti_Sprite_Select_1_Main(SocketGuildUser user, RestUserMessage message)
        {
            ...
            embed.WithDescription("" +
                $"Type in the sprite number of {multimaker_session.MakerCommand.Character_Data_1.Set_Data.Name}'s sprite set that you'd like to use.\n" +
                $"\n" +
            ...
            menuSession.CurrentMenu = "MakerMulti_Sprite_Select_1_Main";
        ...
        public static async Task MakerMulti_Sprite_Select_1_Invalid_Base_Sprite(SocketGuildUser user, RestUserMessage message)
        {
            ...
            var component = new ComponentBuilder()
                .WithButton("Retry", customId: "makermulti-char-entry-1-modal-open", ButtonStyle.Primary);
            ...
            // Edit the menu session according to the current message.
            menuSession.CurrentMenu = "MakerMulti_Sprite_Select_1_Invalid_Base_Sprite";
            menuSession.MenuTimer = new Timer()
            {
                // Create a timer that expires as a "time out" duration for the user.
                Interval = MenuConfig.menu.timerDuration,
        ...
        public static async Task MakerMulti_Sprite_Select_1_Error_Too_Many_Animation_Frames(SocketGuildUser user, RestUserMessage message)
        {
            // Get the account information of the command's user.
            var account = UserInfoClasses.GetAccount(user);
            ...
            // Edit the menu session according to the current message.
            menuSession.CurrentMenu = "MakerMulti_Sprite_Select_1_Error_Too_Many_Animation_Frames";
            menuSession.MenuTimer = new Timer()
            {
                // Create a timer that expires as a "time out" duration for the user.
                Interval = MenuConfig.menu.timerDuration,
        ...
        public static async Task MakerMulti_Sprite_Select_1_Error_Non_Digit_In_Sprite_Number(SocketGuildUser user, RestUserMessage message)
        {
            // Get the account information of the command's user.
            var account = UserInfoClasses.GetAccount(user);
            ...
            // Edit the menu session according to the current message.
            menuSession.CurrentMenu = "MakerMulti_Sprite_Select_1_Error_Non_Digit_In_Sprite_Number";
            menuSession.MenuTimer = new Timer()
            {
                // Create a timer that expires as a "time out" duration for the user.
                Interval = MenuConfig.menu.timerDuration,
        ...
        public static async Task MakerMulti_Sprite_Select_1_Error_Animation_Frame_With_Blank_Sprite(SocketGuildUser user, RestUserMessage message)
        {
            // Get the account information of the command's user.
            var account = UserInfoClasses.GetAccount(user);
            ...
            // Edit the menu session according to the current message.
            menuSession.CurrentMenu = "MakerMulti_Sprite_Select_1_Error_Animation_Frame_With_Blank_Sprite";
            menuSession.MenuTimer = new Timer()
            {
                // Create a timer that expires as a "time out" duration for the user.
                Interval = MenuConfig.menu.timerDuration,
        ...
        public static async Task MakerMulti_Sprite_Select_1_Error_Eye_Frame_Not_Found(SocketGuildUser user, RestUserMessage message)
        {
            // Get the account information of the command's user.
            var account = UserInfoClasses.GetAccount(user);
            ...
            // Edit the menu session according to the current message.
            menuSession.CurrentMenu = "MakerMulti_Sprite_Select_1_Error_Eye_Frame_Not_Found";
            menuSession.MenuTimer = new Timer()
            {
                // Create a timer that expires as a "time out" duration for the user.
                Interval = MenuConfig.menu.timerDuration,
        ...
        public static async Task MakerMulti_Sprite_Select_1_Error_Mouth_Frame_Not_Found(SocketGuildUser user, RestUserMessage message)
        {
            // Get the account information of the command's user.
            var account = UserInfoClasses.GetAccount(user);
            ...
            // Edit the menu session according to the current message.
            menuSession.CurrentMenu = "MakerMulti_Sprite_Select_1_Error_Mouth_Frame_Not_Found";
            menuSession.MenuTimer = new Timer()
            {
                // Create a timer that expires as a "time out" duration for the user.
                Interval = MenuConfig.menu.timerDuration,
