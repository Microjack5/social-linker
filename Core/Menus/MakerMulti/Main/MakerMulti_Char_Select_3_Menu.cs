...
{
    class MakerMulti_Char_Select_3_Menu
    {
        public static async Task MakerMulti_Character_Select_3_Main(SocketGuildUser user, RestUserMessage message)
        {
            ...
            embed.WithDescription("" +
                $"Type in the name of the third {OfficialSetMethods.AcronymToFullTitle(multimaker_session.MakerMultiCommand.Template)} character you'd like to use.\n" +
                $"\n" +
            ...
            menuSession.CurrentMenu = "MakerMulti_Character_Select_3_Main";
        ...
        public static async Task MakerMulti_Character_Select_3_Invalid_Character(SocketGuildUser user, RestUserMessage message, string user_input)
        {
            // Get the account information of the command's user.
            var account = UserInfoClasses.GetAccount(user);
            ...
            // Edit the menu session according to the current message.
            menuSession.CurrentMenu = "MakerMulti_Character_Select_1_Invalid_Character";
            menuSession.MenuTimer = new Timer()
            {
                // Create a timer that expires as a "time out" duration for the user.
                Interval = MenuConfig.menu.timerDuration,
