...
{
    internal class MakerMulti_Char_Select_2_Menu
    {
        public static async Task MakerMulti_Character_Select_2_Main(SocketGuildUser user, RestUserMessage message)
        {
            ...
            menuSession.CurrentMenu = "MakerMulti_Character_Select_2_Main";
        ...
        public static async Task MakerMulti_Character_Select_2_Invalid_Character(SocketGuildUser user, RestUserMessage message, string user_input)
        {
            // Get the account information of the command's user.
            var account = UserInfoClasses.GetAccount(user);
