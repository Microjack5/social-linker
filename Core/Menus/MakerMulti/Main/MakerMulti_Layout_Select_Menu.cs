...
namespace SocialLinker.Core.Menus.MakerMulti.Main
{
    class MakerMulti_Layout_Select_Menu
    {
        ...
        public static async Task MakerMulti_BBTAG_Layout_Select_Main(SocketGuildUser user, RestUserMessage message)
        {
            // Get the account information of the command's user.
            var account = UserInfoClasses.GetAccount(user);
            ...
            embed.WithDescription("" +
                "Choose a placement configuration for character sprites.\n" +
                "\n" +
                ":one: One character left + One character right\n" +
                ":two: Tag team left\n" +
                ":three: Tag team right\n" +
                ":four: Tag team centered\n" +
                ":five: One character left + Tag team right\n" +
                ":six: Tag team left + One character right\n" +
                ":seven: Tag team left + Tag team right\n");
            ...
            // Edit the menu session according to the current message.
            menuSession.CurrentMenu = "MakerMulti_BBTAG_Layout_Select_Main";
            menuSession.MenuTimer = new Timer()
            {
                // Create a timer that expires as a "time out" duration for the user.
                Interval = MenuConfig.menu.timerDuration,
