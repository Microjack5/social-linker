...
{
    class MakerMulti_Dialogue_Select_Menu
    {
        public static async Task MakerMulti_Dialogue_Select_Main(SocketGuildUser user, RestUserMessage message)
        {
            ...
            menuSession.CurrentMenu = "MakerMulti_Dialogue_Select_Main";
