...
{
    class MakerMulti_Speaker_Select_Menu
    {
        public static async Task MakerMulti_Speaker_Select_Main(SocketGuildUser user, RestUserMessage message)
        {
            try
            {
                ...
                menuSession.CurrentMenu = "MakerMulti_Speaker_Select_Main";
