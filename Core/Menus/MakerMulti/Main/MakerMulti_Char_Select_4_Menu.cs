...
{
    class MakerMulti_Char_Select_4_Menu
    {
        public static async Task MakerMulti_Character_Select_4_Main(SocketGuildUser user, RestUserMessage message)
        {
            ...
            embed.WithDescription("" +
                $"Type in the name of the fourth {OfficialSetMethods.AcronymToFullTitle(multimaker_session.MakerMultiCommand.Template)} character you'd like to use.\n" +
                $"\n" +
            ...
            menuSession.CurrentMenu = "MakerMulti_Character_Select_4_Main";
        ...
        public static async Task MakerMulti_Character_Select_4_Invalid_Character(SocketGuildUser user, RestUserMessage message, string user_input)
        {
            // Get the account information of the command's user.
            var account = UserInfoClasses.GetAccount(user);
            ...
            // Edit the menu session according to the current message.
            menuSession.CurrentMenu = "MakerMulti_Character_Select_4_Invalid_Character";
            menuSession.MenuTimer = new Timer()
            {
                // Create a timer that expires as a "time out" duration for the user.
                Interval = MenuConfig.menu.timerDuration,
