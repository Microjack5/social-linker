...
namespace SocialLinker.Core.Menus.Help.Main
{
    class Credits_Menu
    {
        public static async Task Credits_Page_1(MenuIdStructure menuSession)
        {
        ...
        public static async Task Credits_Page_2(MenuIdStructure menuSession)
        {
            var account = menuSession.Account;
            var user = menuSession.User;
            var message = menuSession.MenuMessage;
            ...
            var component = new ComponentBuilder()
                ...
                .WithButton("💠 Back to Help Menu", customId: "back-to-help-menu", ButtonStyle.Secondary);
