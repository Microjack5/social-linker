...
namespace SocialLinker.Core.Menus.Help.Main
{
    ...
    {
        public static async Task SM_Tutorial_Spriteless_Main(SocketGuildUser user, RestUserMessage message)
        {
        ...
        public static async Task SM_Tutorial_Spriteless_Chara_Page_1(SocketGuildUser user, RestUserMessage message)
        {
            // Get the account information of the command's user.
            var account = UserInfoClasses.GetAccount(user);
            ...
            {
                Text = "" +
                "↩️ Return to Spriteless Scenes Menu | ▶️ Next Page\n" +
                "Page 1 / 2"
            };
        ...
        public static async Task SM_Tutorial_Spriteless_Chara_Page_2(SocketGuildUser user, RestUserMessage message)
        {
            // Get the account information of the command's user.
            var account = UserInfoClasses.GetAccount(user);
        ...
        public static async Task SM_Tutorial_Spriteless_System_Page_1(SocketGuildUser user, RestUserMessage message)
        {
            // Get the account information of the command's user.
            var account = UserInfoClasses.GetAccount(user);
            ...
            embed.WithDescription("" +
                "Use the character keyword `System` followed by a template keyword to create system messages in that template.\n" +
                "\n" +
        ...
        public static async Task SM_Tutorial_Spriteless_System_Page_2(SocketGuildUser user, RestUserMessage message)
        {
            // Get the account information of the command's user.
            var account = UserInfoClasses.GetAccount(user);
