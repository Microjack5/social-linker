...
namespace SocialLinker.Core.Menus.Help.Main
{
    ...
    {
        public static async Task Status_Tutorial_Page_1(SocketGuildUser user, RestUserMessage message)
        {
            ...
            {
                Text = "" +
                "↩️ Return to Help Menu | ▶️ Next Page\n" +
                "Page 1 / 5"
            };
        ...
        public static async Task Status_Tutorial_Page_2(SocketGuildUser user, RestUserMessage message)
        {
            // Get the account information of the command's user.
            var account = UserInfoClasses.GetAccount(user);
        ...
        public static async Task Status_Tutorial_Page_3(SocketGuildUser user, RestUserMessage message)
        {
            // Get the account information of the command's user.
            var account = UserInfoClasses.GetAccount(user);
        ...
        public static async Task Status_Tutorial_Page_4(SocketGuildUser user, RestUserMessage message)
        {
            // Get the account information of the command's user.
            var account = UserInfoClasses.GetAccount(user);
        ...
        public static async Task Status_Tutorial_Page_5(SocketGuildUser user, RestUserMessage message)
        {
            // Get the account information of the command's user.
            var account = UserInfoClasses.GetAccount(user);
        ...
        public static EmbedBuilder MenuTimedOut(SocketGuildUser user)
        {
            ...
            embed.WithDescription($"You can view the status screen tutorial at any time from the **`{BotConfig.bot.cmdPrefix}help`** menu by choosing [Status Screens].");
            return embed;
        }
    }
}
