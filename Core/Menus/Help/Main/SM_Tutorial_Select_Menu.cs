...
namespace SocialLinker.Core.Menus.Help.Main
{
    ...
    {
        public static async Task SM_Tutorial_Select_Main(SocketGuildUser user, RestUserMessage message)
        {
        ...
        public static async Task SM_Tutorial_Select_Advanced(SocketGuildUser user, RestUserMessage message)
        {
            // Get the account information of the command's user.
            var account = UserInfoClasses.GetAccount(user);
            ...
            {
                Text = "" +
                "↩️ Return to Scene Maker Tutorials"
            };
