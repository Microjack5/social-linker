...
namespace SocialLinker.Core.Menus.Settings.Main.Profile
{
    class Profile_Settings_Menu
    {
        ...
        public static EmbedBuilder MenuTimedOut(SocketGuildUser user)
        {
            ...
            embed.WithDescription($"You can view and change your profile settings at any time with the **`{BotConfig.bot.cmdPrefix}settings`** command by choosing [Profile Settings].");
            return embed;
        }
    }
}
