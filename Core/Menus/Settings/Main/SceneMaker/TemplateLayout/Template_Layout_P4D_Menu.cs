...
namespace SocialLinker.Core.Menus.Settings.Main.SceneMaker.TemplateLayout
{
    ...
    {
        public static async Task Template_Layout_P4D_Main(SocketGuildUser user, RestUserMessage message)
        {
        ...
        public static async Task Template_Layout_P4D_Scene_Type(SocketGuildUser user, RestUserMessage message)
        {
            // Get the account information of the command's user.
            var account = UserInfoClasses.GetAccount(user);
        ...
        public static async Task Template_Layout_P4D_Auto_Advance(SocketGuildUser user, RestUserMessage message)
        {
            // Get the account information of the command's user.
            var account = UserInfoClasses.GetAccount(user);
        ...
        public static async Task Template_Layout_P4D_Sprite_Placement(SocketGuildUser user, RestUserMessage message)
        {
            // Get the account information of the command's user.
            var account = UserInfoClasses.GetAccount(user);
        ...
        public static async Task Template_Layout_P4D_Dual_Character(SocketGuildUser user, RestUserMessage message)
        {
            // Get the account information of the command's user.
            var account = UserInfoClasses.GetAccount(user);
            ...
            embed.WithDescription("" +
                ...
                "\n" +
                $"⚙️ **Current setting:** **`{account.P4D_TS_Dual}`**\n" +
                "\n" +
                ":one: Normal\n" +
                ":two: Navigator\n" +
                ":three: Phone Call\n");
            ...
            // Edit the menu session according to the current message.
            menuSession.CurrentMenu = "Template_Layout_P4D_Dual_Character";
            menuSession.MenuTimer = new Timer()
            {
                // Create a timer that expires as a "time out" duration for the user.
                Interval = MenuConfig.menu.timerDuration,
        ...
        public static async Task Template_Layout_P4D_Navigator_Caller_Location(SocketGuildUser user, RestUserMessage message)
        {
            // Get the account information of the command's user.
            var account = UserInfoClasses.GetAccount(user);
            ...
            var author = new EmbedAuthorBuilder
            {
                Name = "Navigator & Caller Location",
                IconUrl = user.GetAvatarUrl()
            };
            ...
            var footer = new EmbedFooterBuilder
            {
                Text = "💠 Return to P4D Template Settings"
            };
            ...
            embed.WithDescription("" +
                ...
                "\n" +
                $"⚙️ **Current setting:** **`Location {account.P4D_TS_Nav_Call_Location}`**\n" +
                $"\n" +
                $":one: Location 1\n" +
                $":two: Location 2\n" +
                $":three: Location 3\n");
            ...
            // Edit the menu session according to the current message.
            menuSession.CurrentMenu = "Template_Layout_P4D_Navigator_Caller_Location";
            menuSession.MenuTimer = new Timer()
            {
                // Create a timer that expires as a "time out" duration for the user.
                Interval = MenuConfig.menu.timerDuration,
        ...
        public static async Task Template_Layout_P4D_Scene_Type_Confirm(SocketGuildUser user, RestUserMessage message)
        {
            // Get the account information of the command's user.
            var account = UserInfoClasses.GetAccount(user);
            ...
            var footer = new EmbedFooterBuilder
            {
                Text = "💠 P4D Template Settings | ❌ Close Menu"
            };
        ...
        public static async Task Template_Layout_P4D_Auto_Advance_Confirm(SocketGuildUser user, RestUserMessage message)
        {
            // Get the account information of the command's user.
            var account = UserInfoClasses.GetAccount(user);
        ...
        public static async Task Template_Layout_P4D_Sprite_Placement_Confirm(SocketGuildUser user, RestUserMessage message)
        {
            // Get the account information of the command's user.
            var account = UserInfoClasses.GetAccount(user);
        ...
        public static async Task Template_Layout_P4D_Dual_Character_Default_Confirm(SocketGuildUser user, RestUserMessage message)
        {
            // Get the account information of the command's user.
            var account = UserInfoClasses.GetAccount(user);
            ...
            // Edit the menu session according to the current message.
            menuSession.CurrentMenu = "Template_Layout_P4D_Dual_Character_Default_Confirm";
            menuSession.MenuTimer = new Timer()
            {
                // Create a timer that expires as a "time out" duration for the user.
                Interval = MenuConfig.menu.timerDuration,
        ...
        public static async Task Template_Layout_P4D_Dual_Character_Navigator_Caller_Confirm(SocketGuildUser user, RestUserMessage message)
        {
            // Get the account information of the command's user.
            var account = UserInfoClasses.GetAccount(user);
            ...
            var footer = new EmbedFooterBuilder
            {
                Text = "💠 P4D Template Settings | ✅ Confirm | ❌ Close Menu"
            };
            ...
            embed.WithDescription("" +
                $"Left-sided sprites in dual character scenes have been set to **`{account.P4D_TS_Dual}`**.\n" +
                $"\n" +
                $"Navigators and phone calls use different backgrounds in addition to the main one in a scene. View location background settings?\n");
            ...
            // Edit the menu session according to the current message.
            menuSession.CurrentMenu = "Template_Layout_P4D_Dual_Character_Navigator_Caller_Confirm";
            menuSession.MenuTimer = new Timer()
            {
                // Create a timer that expires as a "time out" duration for the user.
                Interval = MenuConfig.menu.timerDuration,
        ...
        public static async Task Template_Layout_P4D_Navigator_Caller_Location_Confirm(SocketGuildUser user, RestUserMessage message)
        {
            // Get the account information of the command's user.
            var account = UserInfoClasses.GetAccount(user);
            ...
            // Edit the menu session according to the current message.
            menuSession.CurrentMenu = "Template_Layout_P4D_Navigator_Caller_Location_Confirm";
            menuSession.MenuTimer = new Timer()
            {
                // Create a timer that expires as a "time out" duration for the user.
                Interval = MenuConfig.menu.timerDuration,
