...
namespace SocialLinker.Core.Menus.Settings.Main.SceneMaker.TemplateLayout
{
    ...
    {
        public static async Task Template_Layout_P4G_Main(SocketGuildUser user, RestUserMessage message)
        {
            ...
            {
                Text = "↩️ Return to P4 Version Select"
            };
        ...
        public static async Task Template_Layout_P4G_Date_Weather(SocketGuildUser user, RestUserMessage message)
        {
            // Get the account information of the command's user.
            var account = UserInfoClasses.GetAccount(user);
            ...
            var footer = new EmbedFooterBuilder
            {
                Text = "↩️ Return to P4G Template Settings"
            };
        ...
        public static async Task Template_Layout_P4G_Date_Weather_Confirm(SocketGuildUser user, RestUserMessage message)
        {
            // Get the account information of the command's user.
            var account = UserInfoClasses.GetAccount(user);
            ...
            var footer = new EmbedFooterBuilder
            {
                Text = "💠 P4G Template Settings | ❌ Close Menu"
            };
