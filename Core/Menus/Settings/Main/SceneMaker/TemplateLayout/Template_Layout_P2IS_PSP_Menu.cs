...
namespace SocialLinker.Core.Menus.Settings.Main.SceneMaker.TemplateLayout
{
    ...
    {
        public static async Task Template_Layout_P2IS_PSP_Main(SocketGuildUser user, RestUserMessage message)
        {
            ...
            {
                Name = "Template Settings - Persona 2: Innocent Sin (Remake)",
        ...
        public static async Task Template_Layout_P2IS_PSP_Inverted_Filter(SocketGuildUser user, RestUserMessage message)
        {
            // Get the account information of the command's user.
            var account = UserInfoClasses.GetAccount(user);
        ...
        public static async Task Template_Layout_P2IS_PSP_Placement(SocketGuildUser user, RestUserMessage message)
        {
            // Get the account information of the command's user.
            var account = UserInfoClasses.GetAccount(user);
        ...
        public static async Task Template_Layout_P2IS_PSP_Sprite_Flip(SocketGuildUser user, RestUserMessage message)
        {
            // Get the account information of the command's user.
            var account = UserInfoClasses.GetAccount(user);
        ...
        public static async Task Template_Layout_P2IS_PSP_Inverted_Filter_Confirm(SocketGuildUser user, RestUserMessage message)
        {
            // Get the account information of the command's user.
            var account = UserInfoClasses.GetAccount(user);
        ...
        public static async Task Template_Layout_P2IS_PSP_Placement_Confirm(SocketGuildUser user, RestUserMessage message)
        {
            // Get the account information of the command's user.
            var account = UserInfoClasses.GetAccount(user);
        ...
        public static async Task Template_Layout_P2IS_PSP_Sprite_Flip_Confirm(SocketGuildUser user, RestUserMessage message)
        {
            // Get the account information of the command's user.
            var account = UserInfoClasses.GetAccount(user);
