...
namespace SocialLinker.Core.Menus.Settings.Main.SceneMaker.TemplateLayout
{
    class Template_Layout_P1_PS1_Menu
    {
        ...
        public static async Task Template_Layout_P1_PS1_Wallpaper(SocketGuildUser user, RestUserMessage message)
        {
            ...
            var footer = new EmbedFooterBuilder
            {
                Text = "↩️ Return to Revelation: Persona Template Settings"
            };
        ...
        public static async Task Template_Layout_P1_PS1_Placement(SocketGuildUser user, RestUserMessage message)
        {
            ...
            embed.WithDescription("" +
                ...
                ":two: Center\n" +
                ":three: Right\n" +
                ":four: Switch - *Switch between left, right, and center placements for up to three used characters.*\n");
        ...
        public static async Task Template_Layout_P1_PS1_Wallpaper_Confirm(SocketGuildUser user, RestUserMessage message)
        {
            ...
            var footer = new EmbedFooterBuilder
            {
                Text = "💠 Revelation: Persona Template Settings | ❌ Close Menu"
            };
