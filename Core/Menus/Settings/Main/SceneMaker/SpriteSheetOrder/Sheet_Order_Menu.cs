...
namespace SocialLinker.Core.Menus.Settings.Main.SceneMaker.SpriteSheetOrder
{
    ...
    {
        public static async Task Sheet_Order_Main(SocketGuildUser user, RestUserMessage message)
        {
        ...
        public static async Task Sheet_Order_Confirm(SocketGuildUser user, RestUserMessage message)
        {
            // Get the account information of the command's user.
            var account = UserInfoClasses.GetAccount(user);
