...
namespace SocialLinker.Core.Menus.Settings.Main.SceneMaker.AutoDelete
{
    ...
    {
        public static async Task Auto_Delete_Main(SocketGuildUser user, RestUserMessage message)
        {
        ...
        public static async Task Auto_Delete_Commands(SocketGuildUser user, RestUserMessage message)
        {
            // Get the account information of the command's user.
            var account = UserInfoClasses.GetAccount(user);
            ...
            embed.WithDescription("" +
                "**Toggle auto-deletion of successful scene maker commands on and off.**\n" +
                "\n" +
        ...
        public static async Task Auto_Delete_Error_Messages(SocketGuildUser user, RestUserMessage message)
        {
            // Get the account information of the command's user.
            var account = UserInfoClasses.GetAccount(user);
        ...
        public static async Task Auto_Delete_Commands_Confirm(SocketGuildUser user, RestUserMessage message)
        {
            // Get the account information of the command's user.
            var account = UserInfoClasses.GetAccount(user);
            ...
            embed.WithDescription("" +
                $"Auto-delete settings for scene maker commands has been set to **`{account.Auto_Delete_Commands}`**.\n");
        ...
        public static async Task Auto_Delete_Error_Messages_Confirm(SocketGuildUser user, RestUserMessage message)
        {
            // Get the account information of the command's user.
            var account = UserInfoClasses.GetAccount(user);
