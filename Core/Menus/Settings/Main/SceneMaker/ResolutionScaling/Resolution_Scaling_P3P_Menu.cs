...
namespace SocialLinker.Core.Menus.Settings.Main.SceneMaker.ResolutionScaling
{
    ...
    {
        public static async Task Resolution_Scaling_P3P_Main(SocketGuildUser user, RestUserMessage message)
        {
        ...
        public static async Task Resolution_Scaling_P3P_Output_Resolution(SocketGuildUser user, RestUserMessage message)
        {
            // Get the account information of the command's user.
            var account = UserInfoClasses.GetAccount(user);
            ...
            var footer = new EmbedFooterBuilder
            {
                Text = "↩️ P3P Resolution & Scaling Menu"
            };
        ...
        public static async Task Resolution_Scaling_P3P_Scaling_Method(SocketGuildUser user, RestUserMessage message)
        {
            // Get the account information of the command's user.
            var account = UserInfoClasses.GetAccount(user);
            ...
            // Edit the menu session according to the current message.
            menuSession.CurrentMenu = "Resolution_Scaling_P3P_Scaling_Method";
            menuSession.MenuTimer = new Timer()
            {
                // Create a timer that expires as a "time out" duration for the user.
                Interval = MenuConfig.menu.timerDuration,
        ...
        public static async Task Resolution_Scaling_P3P_Output_Resolution_Confirm(SocketGuildUser user, RestUserMessage message)
        {
            // Get the account information of the command's user.
            var account = UserInfoClasses.GetAccount(user);
            ...
            var footer = new EmbedFooterBuilder
            {
                Text = "💠 P3P Resolution & Scaling Menu | ❌ Close Menu"
            };
        ...
        public static async Task Resolution_Scaling_P3P_Scaling_Method_Confirm(SocketGuildUser user, RestUserMessage message)
        {
            // Get the account information of the command's user.
            var account = UserInfoClasses.GetAccount(user);
