...
namespace SocialLinker.Core.Menus.Settings.Main.SceneMaker.ResolutionScaling
{
    ...
    {
        public static async Task Resolution_Scaling_P1_PS1_Main(SocketGuildUser user, RestUserMessage message)
        {
        ...
        public static async Task Resolution_Scaling_P1_PS1_Scaling_Method(SocketGuildUser user, RestUserMessage message)
        {
            // Get the account information of the command's user.
            var account = UserInfoClasses.GetAccount(user);
        ...
        public static async Task Resolution_Scaling_P1_PS1_Output_Resolution_Confirm(SocketGuildUser user, RestUserMessage message)
        {
            // Get the account information of the command's user.
            var account = UserInfoClasses.GetAccount(user);
            ...
            var footer = new EmbedFooterBuilder
            {
                Text = "💠 Revelations: Persona Resolution & Scaling Menu | ❌ Close Menu"
            };
        ...
        public static async Task Resolution_Scaling_P1_PS1_Scaling_Method_Confirm(SocketGuildUser user, RestUserMessage message)
        {
            // Get the account information of the command's user.
            var account = UserInfoClasses.GetAccount(user);
