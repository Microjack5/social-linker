...
namespace SocialLinker.Core.Menus.Settings.Main.SceneMaker.ResolutionScaling
{
    ...
    {
        public static async Task Resolution_Scaling_P3F_Main(SocketGuildUser user, RestUserMessage message)
        {
        ...
        public static async Task Resolution_Scaling_P3F_Output_Resolution(SocketGuildUser user, RestUserMessage message)
        {
            // Get the account information of the command's user.
            var account = UserInfoClasses.GetAccount(user);
            ...
            var footer = new EmbedFooterBuilder
            {
                Text = "↩️ P3F Resolution & Scaling Menu"
            };
            ...
            embed.AddField(":one: 640 × 448", "" +
                "Original PlayStation® 2 internal resolution.");

            embed.AddField(":two: 640 × 480", "" +
                "Original PlayStation® 2 output resolution.");

            embed.AddField(":three: 1440 × 1080", "" +
        ...
        public static async Task Resolution_Scaling_P3F_Scaling_Method(SocketGuildUser user, RestUserMessage message)
        {
            // Get the account information of the command's user.
            var account = UserInfoClasses.GetAccount(user);
        ...
        public static async Task Resolution_Scaling_P3F_Output_Resolution_Confirm(SocketGuildUser user, RestUserMessage message)
        {
            // Get the account information of the command's user.
            var account = UserInfoClasses.GetAccount(user);
            ...
            var footer = new EmbedFooterBuilder
            {
                Text = "💠 P3F Resolution & Scaling Menu | ❌ Close Menu"
            };
        ...
        public static async Task Resolution_Scaling_P3F_Scaling_Method_Confirm(SocketGuildUser user, RestUserMessage message)
        {
            // Get the account information of the command's user.
            var account = UserInfoClasses.GetAccount(user);
