...
namespace SocialLinker.Core.Menus.Settings.Main.SceneMaker.ResolutionScaling
{
    ...
    {
        public static async Task Resolution_Scaling_P2IS_PSP_Main(SocketGuildUser user, RestUserMessage message)
        {
            ...
            {
                Name = "Resolution & Scaling - Persona 2: Innocent Sin (Remake)",
        ...
        public static async Task Resolution_Scaling_P2IS_PSP_Scaling_Method(SocketGuildUser user, RestUserMessage message)
        {
            // Get the account information of the command's user.
            var account = UserInfoClasses.GetAccount(user);
        ...
        public static async Task Resolution_Scaling_P2IS_PSP_Output_Resolution_Confirm(SocketGuildUser user, RestUserMessage message)
        {
            // Get the account information of the command's user.
            var account = UserInfoClasses.GetAccount(user);
            ...
            var footer = new EmbedFooterBuilder
            {
                Text = "💠 P2IS (Remake) Resolution & Scaling Menu | ❌ Close Menu"
            };
        ...
        public static async Task Resolution_Scaling_P2IS_PSP_Scaling_Method_Confirm(SocketGuildUser user, RestUserMessage message)
        {
            // Get the account information of the command's user.
            var account = UserInfoClasses.GetAccount(user);
