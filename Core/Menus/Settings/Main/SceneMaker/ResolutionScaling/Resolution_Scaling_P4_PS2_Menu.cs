...
namespace SocialLinker.Core.Menus.Settings.Main.SceneMaker.ResolutionScaling
{
    ...
    {
        public static async Task Resolution_Scaling_P4_PS2_Main(SocketGuildUser user, RestUserMessage message)
        {
        ...
        public static async Task Resolution_Scaling_P4_PS2_Output_Resolution(SocketGuildUser user, RestUserMessage message)
        {
            // Get the account information of the command's user.
            var account = UserInfoClasses.GetAccount(user);
            ...
            var footer = new EmbedFooterBuilder
            {
                Text = "↩️ P4 (PlayStation® 2) Resolution & Scaling Menu"
            };
        ...
        public static async Task Resolution_Scaling_P4_PS2_Scaling_Method(SocketGuildUser user, RestUserMessage message)
        {
            // Get the account information of the command's user.
            var account = UserInfoClasses.GetAccount(user);
        ...
        public static async Task Resolution_Scaling_P4_PS2_Scaling_Method_Confirm(SocketGuildUser user, RestUserMessage message)
        {
            // Get the account information of the command's user.
            var account = UserInfoClasses.GetAccount(user);
