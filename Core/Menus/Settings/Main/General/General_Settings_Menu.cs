...
{
    class General_Settings_Menu
    {
        public static async Task General_Settings_Main(SocketGuildUser user, RestUserMessage message)
        {
            ...
            embed.AddField(":one: Time Zone & Weather",
                "Adjust time zone and weather settings.");
            embed.AddField(":two: Level Up Notifications",
                "Adjust level up notification settings.");
            embed.AddField(":three: Rank Up Notifications",
                "Adjust rank up notification settings.");
            embed.AddField(":four: Content Filter",
            ...
            menuSession.CurrentMenu = "General_Settings_Menu";
