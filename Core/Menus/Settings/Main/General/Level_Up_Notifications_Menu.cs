...
namespace SocialLinker.Core.Menus.Settings.Main.General
{
    ...
    {
        public static async Task Level_Up_Notifications_Main(SocketGuildUser user, RestUserMessage message)
        {
        ...
        public static EmbedBuilder MenuTimedOut(SocketGuildUser user)
        {
            ...
            embed.WithDescription($"You can edit your notifications at any time from the **`{BotConfig.bot.cmdPrefix}settings`** menu by choosing [General Settings] > [Level Up Notifications].");
            return embed;
        }
    }
}
