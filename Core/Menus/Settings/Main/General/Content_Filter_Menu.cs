...
namespace SocialLinker.Core.Menus.Settings.Main.General
{
    class Content_Filter_Menu
    {
        ...
        public static EmbedBuilder MenuTimedOut(SocketGuildUser user)
        {
            ...
            embed.WithDescription($"You can edit your content settings at any time from the **`{BotConfig.bot.cmdPrefix}settings`** menu by choosing [General Settings] > [Content Filter].");
            return embed;
        }
    }
}
