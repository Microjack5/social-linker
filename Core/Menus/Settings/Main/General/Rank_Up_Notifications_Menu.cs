...
namespace SocialLinker.Core.Menus.Settings.Main.General
{
    class Rank_Up_Notifications_Menu
    {
        ...
        public static EmbedBuilder MenuTimedOut(SocketGuildUser user)
        {
            ...
            embed.WithDescription($"You can edit your notifications at any time from the **`{BotConfig.bot.cmdPrefix}settings`** menu by choosing [General Settings] > [Rank Up Notifications].");
            return embed;
        }
    }
}
