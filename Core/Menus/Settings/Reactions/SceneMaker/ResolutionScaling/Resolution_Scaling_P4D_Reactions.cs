...
{
    class Resolution_Scaling_P4D_Reactions
    {
        public static Task Nav_Resolution_Scaling_P4D_Main(SocketReaction reaction, MenuIdStructure menuSession)
        {
            ...
            else if (reaction.Emote.Name == "\u0031\ufe0f\u20e3")
            {
                ...
                // Go to a new menu.
                _ = Resolution_Scaling_P4D_Menu.Resolution_Scaling_P4D_Output_Resolution(menuSession.User, menuSession.MenuMessage);
                return Task.CompletedTask;
            }
            ...
            else if (reaction.Emote.Name == "\u0032\ufe0f\u20e3")
            {
                ...
                // Go to a new menu.
                _ = Resolution_Scaling_P4D_Menu.Resolution_Scaling_P4D_Scaling_Method(menuSession.User, menuSession.MenuMessage);
                return Task.CompletedTask;
            }
        ...
        public static Task Nav_Resolution_Scaling_P4D_Scaling_Method(SocketReaction reaction, MenuIdStructure menuSession)
        {
            if (reaction.Emote.Name == "↩️")
            {
                // Stop the timeout timer associated with the menu.
            ...
            else if (reaction.Emote.Name == "\u0031\ufe0f\u20e3")
            {
                ...
                // Go to a new menu.
                _ = Resolution_Scaling_P4D_Menu.Resolution_Scaling_P4D_Scaling_Method_Confirm(menuSession.User, menuSession.MenuMessage);
                return Task.CompletedTask;
            }
        ...
        public static Task Nav_Resolution_Scaling_P4D_Output_Resolution_Confirm(SocketReaction reaction, MenuIdStructure menuSession)
        {
