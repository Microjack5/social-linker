...
namespace SocialLinker.Core.Menus.Settings.Reactions.SceneMaker.ResolutionScaling
{
    class Resolution_Scaling_P2EP_PSP_Reactions
    {
        ...
        public static Task Nav_Resolution_Scaling_P2EP_PSP_Output_Resolution(SocketReaction reaction, MenuIdStructure menuSession)
        {
            if (reaction.Emote.Name == "↩️")
            {
                // Stop the timeout timer associated with the menu.
            ...
            else if (reaction.Emote.Name == "\u0031\ufe0f\u20e3")
            {
                ...
                // Go to a new menu.
                _ = Resolution_Scaling_P2EP_PSP_Menu.Resolution_Scaling_P2EP_PSP_Output_Resolution_Confirm(menuSession.User, menuSession.MenuMessage);
                return Task.CompletedTask;
            }
        ...
        public static Task Nav_Resolution_Scaling_P2EP_PSP_Scaling_Method(SocketReaction reaction, MenuIdStructure menuSession)
        {
            if (reaction.Emote.Name == "↩️")
            {
                // Stop the timeout timer associated with the menu.
            ...
            else if (reaction.Emote.Name == "\u0031\ufe0f\u20e3")
            {
                ...
                // Go to a new menu.
                _ = Resolution_Scaling_P2EP_PSP_Menu.Resolution_Scaling_P2EP_PSP_Scaling_Method_Confirm(menuSession.User, menuSession.MenuMessage);
                return Task.CompletedTask;
            }
        ...
        public static Task Nav_Resolution_Scaling_P2EP_PSP_Output_Resolution_Confirm(SocketReaction reaction, MenuIdStructure menuSession)
        {
        ...
        public static Task Nav_Resolution_Scaling_P2EP_PSP_Scaling_Method_Confirm(SocketReaction reaction, MenuIdStructure menuSession)
        {
            if (reaction.Emote.Name == "💠")
            {
                // Stop the timeout timer associated with the menu.
