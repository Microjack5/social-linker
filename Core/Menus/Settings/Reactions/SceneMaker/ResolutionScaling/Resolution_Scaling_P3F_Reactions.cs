...
namespace SocialLinker.Core.Menus.Settings.Reactions.SceneMaker.ResolutionScaling
{
    ...
    {
        public static Task Nav_Resolution_Scaling_P3F_Main(SocketReaction reaction, MenuIdStructure menuSession)
        {
            ...
            else if (reaction.Emote.Name == "\u0031\ufe0f\u20e3")
            {
                ...
                // Go to a new menu.
                _ = Resolution_Scaling_P3F_Menu.Resolution_Scaling_P3F_Output_Resolution(menuSession.User, menuSession.MenuMessage);
                return Task.CompletedTask;
            }
            ...
            else if (reaction.Emote.Name == "\u0032\ufe0f\u20e3")
            {
                ...
                // Go to a new menu.
                _ = Resolution_Scaling_P3F_Menu.Resolution_Scaling_P3F_Scaling_Method(menuSession.User, menuSession.MenuMessage);
                return Task.CompletedTask;
            }
        ...
        public static Task Nav_Resolution_Scaling_P3F_Scaling_Method(SocketReaction reaction, MenuIdStructure menuSession)
        {
            if (reaction.Emote.Name == "↩️")
            {
                // Stop the timeout timer associated with the menu.
            ...
            else if (reaction.Emote.Name == "\u0031\ufe0f\u20e3")
            {
                ...
                // Go to a new menu.
                _ = Resolution_Scaling_P3F_Menu.Resolution_Scaling_P3F_Scaling_Method_Confirm(menuSession.User, menuSession.MenuMessage);
                return Task.CompletedTask;
            }
        ...
        public static Task Nav_Resolution_Scaling_P3F_Output_Resolution_Confirm(SocketReaction reaction, MenuIdStructure menuSession)
        {
        ...
        public static Task Nav_Resolution_Scaling_P3F_Scaling_Method_Confirm(SocketReaction reaction, MenuIdStructure menuSession)
        {
            if (reaction.Emote.Name == "💠")
            {
                // Stop the timeout timer associated with the menu.
