...
namespace SocialLinker.Core.Menus.Settings.Reactions.SceneMaker.TemplateLayout
{
    ...
    {
        public static Task Nav_Template_Layout_P4AU_Main(SocketReaction reaction, MenuIdStructure menuSession)
        {
            ...
            else if (reaction.Emote.Name == "\u0031\ufe0f\u20e3")
            {
                ...
                // Go to a new menu.
                _ = Template_Layout_P4AU_Menu.Template_Layout_P4AU_Scene_Type(menuSession.User, menuSession.MenuMessage);
                return Task.CompletedTask;
            }
            ...
            else if (reaction.Emote.Name == "\u0032\ufe0f\u20e3")
            {
                ...
                // Go to a new menu.
                _ = Template_Layout_P4AU_Menu.Template_Layout_P4AU_Auto_Advance(menuSession.User, menuSession.MenuMessage);
                return Task.CompletedTask;
            }
            ...
            else if (reaction.Emote.Name == "\u0033\ufe0f\u20e3")
            {
                ...
                // Go to a new menu.
                _ = Template_Layout_P4AU_Menu.Template_Layout_P4AU_Control_Panel(menuSession.User, menuSession.MenuMessage);
                return Task.CompletedTask;
            }
            ...
            else if (reaction.Emote.Name == "\u0034\ufe0f\u20e3")
            {
                ...
                // Go to a new menu.
                _ = Template_Layout_P4AU_Menu.Template_Layout_P4AU_Sprite_Placement(menuSession.User, menuSession.MenuMessage);
                return Task.CompletedTask;
            }
            ...
            else if (reaction.Emote.Name == "\u0035\ufe0f\u20e3")
            {
                ...
                // Go to a new menu.
                _ = Template_Layout_P4AU_Menu.Template_Layout_P4AU_Highlight(menuSession.User, menuSession.MenuMessage);
                return Task.CompletedTask;
            }
        ...
        public static Task Nav_Template_Layout_P4AU_Scene_Type(SocketReaction reaction, MenuIdStructure menuSession)
        {
            if (reaction.Emote.Name == "↩️")
            {
                // Stop the timeout timer associated with the menu.
            ...
            else if (reaction.Emote.Name == "\u0031\ufe0f\u20e3")
            {
                ...
                // Go to a new menu.
                _ = Template_Layout_P4AU_Menu.Template_Layout_P4AU_Scene_Type_Confirm(menuSession.User, menuSession.MenuMessage);
                return Task.CompletedTask;
            }
        ...
        public static Task Nav_Template_Layout_P4AU_Auto_Advance(SocketReaction reaction, MenuIdStructure menuSession)
        {
            if (reaction.Emote.Name == "↩️")
            {
                // Stop the timeout timer associated with the menu.
            ...
            else if (reaction.Emote.Name == "\u0031\ufe0f\u20e3")
            {
                ...
                // Go to a new menu.
                _ = Template_Layout_P4AU_Menu.Template_Layout_P4AU_Auto_Advance_Confirm(menuSession.User, menuSession.MenuMessage);
                return Task.CompletedTask;
            }
        ...
        public static Task Nav_Template_Layout_P4AU_Sprite_Placement(SocketReaction reaction, MenuIdStructure menuSession)
        {
            if (reaction.Emote.Name == "↩️")
            {
                // Stop the timeout timer associated with the menu.
            ...
            else if (reaction.Emote.Name == "\u0031\ufe0f\u20e3")
            {
                ...
                // Go to a new menu.
                _ = Template_Layout_P4AU_Menu.Template_Layout_P4AU_Sprite_Placement_Confirm(menuSession.User, menuSession.MenuMessage);
                return Task.CompletedTask;
            }
        ...
        public static Task Nav_Template_Layout_P4AU_Highlight(SocketReaction reaction, MenuIdStructure menuSession)
        {
            if (reaction.Emote.Name == "↩️")
            {
                // Stop the timeout timer associated with the menu.
            ...
            else if (reaction.Emote.Name == "\u0031\ufe0f\u20e3")
            {
                ...
                // Go to a new menu.
                _ = Template_Layout_P4AU_Menu.Template_Layout_P4AU_Highlight_Confirm(menuSession.User, menuSession.MenuMessage);
                return Task.CompletedTask;
            }
        ...
        public static Task Nav_Template_Layout_P4AU_Scene_Type_Confirm(SocketReaction reaction, MenuIdStructure menuSession)
        {
            if (reaction.Emote.Name == "💠")
            {
                // Stop the timeout timer associated with the menu.
        ...
        public static Task Nav_Template_Layout_P4AU_Auto_Advance_Confirm(SocketReaction reaction, MenuIdStructure menuSession)
        {
            if (reaction.Emote.Name == "💠")
            {
                // Stop the timeout timer associated with the menu.
        ...
        public static Task Nav_Template_Layout_P4AU_Control_Panel_Confirm(SocketReaction reaction, MenuIdStructure menuSession)
        {
            if (reaction.Emote.Name == "💠")
            {
                // Stop the timeout timer associated with the menu.
        ...
        public static Task Nav_Template_Layout_P4AU_Sprite_Placement_Confirm(SocketReaction reaction, MenuIdStructure menuSession)
        {
            if (reaction.Emote.Name == "💠")
            {
                // Stop the timeout timer associated with the menu.
        ...
        public static Task Nav_Template_Layout_P4AU_Dual_Character_Default_Confirm(SocketReaction reaction, MenuIdStructure menuSession)
        {
            if (reaction.Emote.Name == "💠")
            {
                // Stop the timeout timer associated with the menu.
        ...
        public static Task Nav_Template_Layout_P4AU_Dual_Character_Navigator_Confirm(SocketReaction reaction, MenuIdStructure menuSession)
        {
            if (reaction.Emote.Name == "💠")
            {
                // Stop the timeout timer associated with the menu.
        ...
        public static Task Nav_Template_Layout_P4AU_Dual_Character_Caller_Confirm(SocketReaction reaction, MenuIdStructure menuSession)
        {
            if (reaction.Emote.Name == "💠")
            {
                // Stop the timeout timer associated with the menu.
            ...
            else if (reaction.Emote.Name == "✅")
            {
                ...
                // Go to a new menu.
                _ = Template_Layout_P4AU_Menu.Template_Layout_P4AU_Caller_Location(menuSession.User, menuSession.MenuMessage);
                return Task.CompletedTask;
            }
            else if (reaction.Emote.Name == "❌")
            {
        ...
        public static Task Nav_Template_Layout_P4AU_Navigator_Location_Confirm(SocketReaction reaction, MenuIdStructure menuSession)
        {
            if (reaction.Emote.Name == "💠")
            {
                // Stop the timeout timer associated with the menu.
        ...
        public static Task Nav_Template_Layout_P4AU_Caller_Location_Confirm(SocketReaction reaction, MenuIdStructure menuSession)
        {
            if (reaction.Emote.Name == "💠")
            {
                // Stop the timeout timer associated with the menu.
        ...
        public static Task Nav_Template_Layout_P4AU_Highlight_Confirm(SocketReaction reaction, MenuIdStructure menuSession)
        {
            if (reaction.Emote.Name == "💠")
            {
                // Stop the timeout timer associated with the menu.
