...
namespace SocialLinker.Core.Menus.Settings.Reactions.SceneMaker.TemplateLayout
{
    ...
    {
        public static Task Nav_Template_Layout_P4G_Main(SocketReaction reaction, MenuIdStructure menuSession)
        {
            ...
            else if (reaction.Emote.Name == "\u0031\ufe0f\u20e3")
            {
                ...
                // Go to a new menu.
                _ = Template_Layout_P4G_Menu.Template_Layout_P4G_Date_Weather(menuSession.User, menuSession.MenuMessage);
                return Task.CompletedTask;
            }
        ...
        public static Task Nav_Template_Layout_P4G_Date_Weather(SocketReaction reaction, MenuIdStructure menuSession)
        {
            if (reaction.Emote.Name == "↩️")
            {
                // Stop the timeout timer associated with the menu.
            ...
            else if (reaction.Emote.Name == "\u0031\ufe0f\u20e3")
            {
                ...
                // Go to a new menu.
                _ = Template_Layout_P4G_Menu.Template_Layout_P4G_Date_Weather_Confirm(menuSession.User, menuSession.MenuMessage);
                return Task.CompletedTask;
            }
        ...
        public static Task Nav_Template_Layout_P4G_Date_Weather_Confirm(SocketReaction reaction, MenuIdStructure menuSession)
        {
