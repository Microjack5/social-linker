    ...
    class Template_Layout_P2IS_PSP_Reactions
    {
        public static Task Nav_Template_Layout_P2IS_PSP_Main(SocketReaction reaction, MenuIdStructure menuSession)
        {
            ...
            else if (reaction.Emote.Name == "\u0033\ufe0f\u20e3")
            {
                ...
                // Go to a new menu.
                _ = Template_Layout_P2IS_PSP_Menu.Template_Layout_P2IS_PSP_Sprite_Flip(menuSession.User, menuSession.MenuMessage);
                return Task.CompletedTask;
            }
        ...
        public static Task Nav_Template_Layout_P2IS_PSP_Inverted_Filter(SocketReaction reaction, MenuIdStructure menuSession)
        {
            if (reaction.Emote.Name == "↩️")
            {
                // Stop the timeout timer associated with the menu.
            ...
            else if (reaction.Emote.Name == "\u0031\ufe0f\u20e3")
            {
                ...
                // Go to a new menu.
                _ = Template_Layout_P2IS_PSP_Menu.Template_Layout_P2IS_PSP_Inverted_Filter_Confirm(menuSession.User, menuSession.MenuMessage);
                return Task.CompletedTask;
            }
        ...
        public static Task Nav_Template_Layout_P2IS_PSP_Placement(SocketReaction reaction, MenuIdStructure menuSession)
        {
            if (reaction.Emote.Name == "↩️")
            {
                // Stop the timeout timer associated with the menu.
            ...
            else if (reaction.Emote.Name == "\u0031\ufe0f\u20e3")
            {
                ...
                // Go to a new menu.
                _ = Template_Layout_P2IS_PSP_Menu.Template_Layout_P2IS_PSP_Placement_Confirm(menuSession.User, menuSession.MenuMessage);
                return Task.CompletedTask;
            }
        ...
        public static Task Nav_Template_Layout_P2IS_PSP_Sprite_Flip(SocketReaction reaction, MenuIdStructure menuSession)
        {
            if (reaction.Emote.Name == "↩️")
            {
                // Stop the timeout timer associated with the menu.
            ...
            else if (reaction.Emote.Name == "\u0031\ufe0f\u20e3")
            {
                ...
                // Go to a new menu.
                _ = Template_Layout_P2IS_PSP_Menu.Template_Layout_P2IS_PSP_Sprite_Flip_Confirm(menuSession.User, menuSession.MenuMessage);
                return Task.CompletedTask;
            }
        ...
        public static Task Nav_Template_Layout_P2IS_PSP_Inverted_Filter_Confirm(SocketReaction reaction, MenuIdStructure menuSession)
        {
        ...
        public static Task Nav_Template_Layout_P2IS_PSP_Placement_Confirm(SocketReaction reaction, MenuIdStructure menuSession)
        {
            if (reaction.Emote.Name == "💠")
            {
                // Stop the timeout timer associated with the menu.
        ...
        public static Task Nav_Template_Layout_P2IS_PSP_Sprite_Flip_Confirm(SocketReaction reaction, MenuIdStructure menuSession)
        {
            if (reaction.Emote.Name == "💠")
            {
                // Stop the timeout timer associated with the menu.
