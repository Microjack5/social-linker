...
namespace SocialLinker.Core.Menus.Settings.Reactions.Profile
{
    ...
    {
        public static Task Nav_Rank_Up_Notifications_Main(SocketMessageComponent component, MenuIdStructure menuSession)
        {
            ...
            switch (component.Data.CustomId)
            {
                ...
                case "on":
                    ...
                    _ = Rank_Up_Notifications_Menu.Rank_Up_Notifications_Confirm(menuSession);
                    break;
        ...
        public static Task Nav_Rank_Up_Notifications_Confirm(SocketMessageComponent component, MenuIdStructure menuSession)
        {
            switch (component.Data.CustomId)
            {
