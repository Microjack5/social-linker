    ...
    public class RenderP3R
    {
        ...
        public async Task Render_Quick_Scene_P3P(SocialLinkerCommand sl_command)
        {
            ...
            using (Graphics graphics = Graphics.FromImage(base_template))
            {
                ...
                graphics.DrawImage(colored_background_bitmap, 0, 0, internal_template_width, internal_template_height);

                // Draw the user's background to the base template.
                graphics.DrawImage(background, 0, 0, internal_template_width, internal_template_height);
                ...
                graphics.DrawImage(message_window, 0, 0, internal_template_width, internal_template_height);

                // Draw the cursor layer to the base template.
                graphics.DrawImage(cursor, 0, 0, internal_template_width, internal_template_height);

                // If the user has the HUD enabled, render it to the template as well.
                if (account.P3F_TS_HUD != "None")
                {
                    graphics.DrawImage(Render_Calendar_HUD(account), 0, 0, internal_template_width, internal_template_height);
                }
            }
            ...
            using (Graphics graphics = Graphics.FromImage(base_template))
            {
                ...
                graphics.DrawImage(Text_To_Red(Render_Name(display_name)), 0, 0, internal_template_width, internal_template_height);
                ...
                graphics.DrawImage(Text_To_Gray(Render_Dialogue(parsed_lines)), 0, 0, internal_template_width, internal_template_height);
            }
        ...
        public Bitmap Render_Calendar_HUD(UserInfoFields account)
        {
            ...
            using (Graphics graphics = Graphics.FromImage(base_template))
            {
                ...
                Bitmap month_tens = new Bitmap(internal_template_width, internal_template_height);
                Bitmap month_ones = new Bitmap(internal_template_width, internal_template_height);

                Bitmap day_tens = new Bitmap(internal_template_width, internal_template_height);
                Bitmap day_ones = new Bitmap(internal_template_width, internal_template_height);

                Bitmap day_of_week = new Bitmap(internal_template_width, internal_template_height);
                Bitmap time_of_day = new Bitmap(internal_template_width, internal_template_height);
                ...
                Bitmap moon_phase_text = new Bitmap(internal_template_width, internal_template_height);
                Bitmap moon_phase_digit_tens = new Bitmap(internal_template_width, internal_template_height);
                Bitmap moon_phase_digit_ones = new Bitmap(internal_template_width, internal_template_height);
                Bitmap moon_phase_image_normal = new Bitmap(internal_template_width, internal_template_height);
                Bitmap moon_phase_image_glow = new Bitmap(internal_template_width, internal_template_height);
                ...
                graphics.DrawImage(hud_top, 0, 0, internal_template_width, internal_template_height);
                graphics.DrawImage(hud_bottom, 0, 0, internal_template_width, internal_template_height);

                graphics.DrawImage(month_tens, 0, 0, internal_template_width, internal_template_height);
                graphics.DrawImage(month_ones, 0, 0, internal_template_width, internal_template_height);
                graphics.DrawImage(date_slash, 0, 0, internal_template_width, internal_template_height);
                graphics.DrawImage(day_tens, 0, 0, internal_template_width, internal_template_height);
                graphics.DrawImage(day_ones, 0, 0, internal_template_width, internal_template_height);

                graphics.DrawImage(day_of_week, 0, 0, internal_template_width, internal_template_height);
                graphics.DrawImage(time_of_day, 0, 0, internal_template_width, internal_template_height);

                // Lastly, render the moon HUD to the template as well.
                if (account.P3F_TS_HUD != "Date Only")
                {
                    graphics.DrawImage(Render_Moon_HUD(account), 0, 0, internal_template_width, internal_template_height);
                }
            }
        ...
        public Bitmap Render_Moon_HUD(UserInfoFields account)
        {
            ...
            Bitmap countdown_text_main = new Bitmap(internal_template_width, internal_template_height);
            Bitmap countdown_text_special = new Bitmap(internal_template_width, internal_template_height);

            Bitmap countdown_tens = new Bitmap(internal_template_width, internal_template_height);
            Bitmap countdown_ones = new Bitmap(internal_template_width, internal_template_height);

            Bitmap moon_background = new Bitmap(internal_template_width, internal_template_height);
            Bitmap moon_phase = new Bitmap(internal_template_width, internal_template_height);
            Bitmap moon_phase_glow = new Bitmap(internal_template_width, internal_template_height);
            ...
            using (Graphics graphics = Graphics.FromImage(base_template))
            {
                ...
                if (cycle_age <= 14.76)
                {
                    ...
                    {
                        moon_background = new Bitmap(internal_template_width, internal_template_height);
                    ...
                    {
                        countdown_tens = new Bitmap(internal_template_width, internal_template_height);
                        countdown_ones = new Bitmap(internal_template_width, internal_template_height);
                        ...
                        countdown_text_main = new Bitmap(internal_template_width, internal_template_height);
                    }
                }
                // Waning phases
                ...
                if (account.P3F_TS_HUD != "Countdown Off")
                {
                    ...
                    {
                        graphics.DrawImage(countdown_text_main, 17, 0, internal_template_width, internal_template_height);
                    }
                    else
                    {
                        graphics.DrawImage(countdown_text_main, 0, 0, internal_template_width, internal_template_height);
                    }

                    graphics.DrawImage(countdown_text_special, 0, 0, internal_template_width, internal_template_height);
                    graphics.DrawImage(countdown_tens, 0, 0, internal_template_width, internal_template_height);
                    graphics.DrawImage(countdown_ones, 0, 0, internal_template_width, internal_template_height);
                }
                graphics.DrawImage(moon_background, 0, 0, internal_template_width, internal_template_height);
                graphics.DrawImage(moon_phase, 0, 0, internal_template_width, internal_template_height);
                graphics.DrawImage(moon_phase_glow, 0, 0, internal_template_width, internal_template_height);
            }
        ...
        public Bitmap Text_To_Red(Bitmap input_bitmap) // Display names
        {
            ...
            // Create a for loop to iterate over the X values of the bitmap to be changed.
            for (int x = 0; x < final_template_width; x++)
            {
                // Create a nested for loop to iterate over the Y values of the bitmap to be changed.
                for (int y = 0; y < final_template_height; y++)
                {
                    // Get the current pixel from the input bitmap.
        ...
        public Bitmap Scale_Template(UserInfoFields account, Bitmap input_template)
        {
            ...
            else
            {
                ...
                {
                    internal_template_width = 640;
                    internal_template_height = 480;
                }
                else if (account.P3F_Resolution == "1440 × 1080")
                {
                    internal_template_width = 1440;
                    internal_template_height = 1080;
                }

                var copied_input = new Bitmap(input_template);
                scaled_bitmap = new Bitmap(internal_template_width, internal_template_height);
                ...
                using (Graphics graphics = Graphics.FromImage(scaled_bitmap))
                {
                    ...
                    graphics.DrawImage(copied_input, 0, 0, internal_template_width + 1, internal_template_height + 1);
                }
