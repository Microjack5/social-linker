...
namespace SocialLinker.Core.SceneMaker.TemplateRenders.QuickScenes
{
    public class RenderP2EP_PS1 : ModuleBase<SocketCommandContext>
    {
        ...
        public async Task Render_Quick_Scene_P2EP_PS1(SocialLinkerCommand sl_command, OfficialSetData set_data, MakerCommandData command_data)
        {
            ...
            using (Graphics graphics = Graphics.FromImage(base_template))
            {
                ...
                List<string>[] dialogue_lines = OfficialSetMethods.Line_Parser(sl_command, "P2EP-PS1", command_data.Dialogue, 3, 230);
