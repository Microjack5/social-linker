...
namespace SocialLinker.Core.SceneMaker.TemplateRenders.QuickScenes
{
    ...
    {
        public static async Task Render_Quick_Scene_P4G(SocialLinkerCommand sl_command)
        {
            ...
            using (Graphics graphics = Graphics.FromImage(base_template))
            {
                ...
                maker_command_data.Dialogue = OfficialSetMethods.Validate_Input(sl_command, "P4G", "Dialogue", maker_command_data.Dialogue);

                List<string>[] parsed_lines = OfficialSetMethods.Line_Parser(sl_command, "P4G", maker_command_data.Dialogue, 3, 1450);
