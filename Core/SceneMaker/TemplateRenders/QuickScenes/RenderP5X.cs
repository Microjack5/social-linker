...
{
    public class RenderP5X : ModuleBase<SocketCommandContext>
    {
        ...
        public async Task Render_Quick_Scene_P5X(SocialLinkerCommand sl_command)
        {
            ...
            RestUserMessage loader = await channel.SendMessageAsync("", false, P5X_Loading_Message().Build());
            ...
            string display_name = "Merope";//OfficialSetMethods.GetDisplayName(account, sl_command.MakerCommand.Character_Data_1);
            ...
            DialogueRenderer renderer = new DialogueRenderer(
                fontName: "Optima nova LT Black",
                fontSize: 32f,
                maxLineWidth: 1000f,
                maxLines: 3,
                widthScale: 1f,
                textCompressionAmount: 1
            );
            ...
            Bitmap screen_border = Render_Screen_Border();
            Bitmap control_panel = Render_Control_Panel();
            ...
            using (Graphics graphics = Graphics.FromImage(base_template))
            {
                ...
                graphics.DrawImage(screen_border, -210, 0, screen_border.Width, screen_border.Height);
                ...
                if (maker_command_data.Character_Data_1.Base_Sprite != 0)
                {
                    ...
                    graphics.DrawImage(drop_shadow, 16 - 50, 432, bustup.Width, bustup.Height);

                    // Render the main bustup next.
                    graphics.DrawImage(bustup, 16, 432, bustup.Width, bustup.Height);

                    graphics.DrawImage(Render_User_ID(account), 0, 0, template_width, template_height);
                }
                ...
                {
                    case 1:
                        graphics.DrawImage(dialogue_bitmap, -23, 0, dialogue_bitmap.Width, dialogue_bitmap.Height);
                        break;
                    ...
                    case 3:
                        graphics.DrawImage(dialogue_bitmap, 0, 5, dialogue_bitmap.Width, dialogue_bitmap.Height);
                        break;
                }
        ...
        public Bitmap Render_User_ID(UserInfoFields account)
        {
            //Bitmap base_template = new Bitmap(template_width, template_height);
            ...
            DialogueRenderResult result = renderer.RenderDialogueAdvanced(
                ...
                lineSpacing: -1.8f,
                drawOutline: false,
                fillColor: System.Drawing.Color.FromArgb(229, 229, 229),
                outlineColor: System.Drawing.Color.Black,
                outlineWidth: 2.5f
            );

            Bitmap base_template = result.Bitmap;

            //return "ID:60002062318";

            return base_template;
        }

        public Bitmap Render_Screen_Border()
        {
            Bitmap border_1 = (Bitmap)System.Drawing.Image.FromFile($@"{AssetDirectoryConfig.assetDirectory.assetFolderPath}//SceneMaker//Templates//P5X//Border//border_1.png");

            return border_1;
        }

        public Bitmap Render_Control_Panel()
        {
            Bitmap control_panel = (Bitmap)System.Drawing.Image.FromFile($@"{AssetDirectoryConfig.assetDirectory.assetFolderPath}//SceneMaker//Templates//P5X//Control_Panel//control_panel_1.png");
        ...
        // Loading message
        public static EmbedBuilder P5X_Loading_Message()
        {
            var embed = new EmbedBuilder();
            var author = new EmbedAuthorBuilder
            {
                Name = "Generating Scene...",
                IconUrl = EmbedSettings.Get_Game_Logo("P5X")
            };

            embed.WithAuthor(author);
            embed.WithColor(EmbedSettings.Get_Game_Color("P5X", null));
            embed.WithThumbnailUrl(EmbedSettings.Get_Loading_Icon("P5X", null));
