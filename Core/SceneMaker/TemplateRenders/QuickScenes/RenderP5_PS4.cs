...
namespace SocialLinker.Core.SceneMaker.TemplateRenders.QuickScenes
{
    public class RenderP5_PS4 : ModuleBase<SocketCommandContext>
    {
        ...
        public async Task Render_Quick_Scene_P5_PS4(SocialLinkerCommand sl_command)
        {
            ...
            maker_command_data.Dialogue = OfficialSetMethods.Validate_Input(sl_command, "P5-PS4", "Dialogue", maker_command_data.Dialogue);
            List<string>[] parsed_lines = OfficialSetMethods.Line_Parser(sl_command, "P5-PS4", maker_command_data.Dialogue, 3, max_line_length);
