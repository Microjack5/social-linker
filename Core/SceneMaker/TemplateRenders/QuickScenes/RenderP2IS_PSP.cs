...
namespace SocialLinker.Core.SceneMaker.TemplateRenders.QuickScenes
{
    internal class RenderP2IS_PSP
    {
        ...
        public async Task Render_Quick_Scene_P2IS_PSP(SocialLinkerCommand sl_command, OfficialSetData set_data, MakerCommandData command_data)
        {
            ...
            Bitmap display_name_layer = Render_Name(bustup_data);
        ...
        public Bitmap Render_Name(BustupData bustup_data)
        {
            Bitmap base_template = new Bitmap(template_width, template_height);
        ...
        public Bitmap Render_Dialogue(List<string>[] dialogue_lines)
        {
            ...
            for (int i = 0; i < dialogue_lines.Length; i++)
            {
                ...
                int render_position_y = 218 + (18 * i);
        ...
        public Bitmap Center_Image(Bitmap input_bitmap)
        {
            ...
            float scale = Math.Min(template_width / image.Width, template_height / image.Height);

            // Create a new bitmap with the specified width and height variables.
            var centered_bitmap = new Bitmap(template_width, template_height);
            ...
            graphics.DrawImage(image, (template_width - scaleWidth) / 2, (template_height - scaleHeight) / 2, scaleWidth, scaleHeight);

            return centered_bitmap;
        }

        public Bitmap Stretch_To_Fit(Bitmap input_bitmap)
        {
            ...
            var new_bitmap = new Bitmap(template_width, template_height);
            ...
            graphics.DrawImage(bitmap_copy, 0, 0, template_width, template_height);
