...
{
    class RenderP2IS_PS1 : ModuleBase<SocketCommandContext>
    {
        ...
        Bitmap font_sheet = (Bitmap)System.Drawing.Image.FromFile($@"{AssetDirectoryConfig.assetDirectory.assetFolderPath}//SceneMaker//Templates//P2IS-PS1//Font//p2is-ps1_font_sheet.png");
        Bitmap ba_gua_bitmap = (Bitmap)System.Drawing.Image.FromFile($@"{AssetDirectoryConfig.assetDirectory.assetFolderPath}//SceneMaker//Templates//P2IS-PS1//Font//p2is-ps1_font_sheet_2.png");
        Bitmap heart_bitmap = (Bitmap)System.Drawing.Image.FromFile($@"{AssetDirectoryConfig.assetDirectory.assetFolderPath}//SceneMaker//Templates//P2IS-PS1//Font//p2is-ps1_font_sheet_3.png");
        ...
        public async Task Render_System_Message(SocialLinkerCommand sl_command, MakerCommandData command_data)
        {
            ...
            List<string>[] dialogue_lines = OfficialSetMethods.Line_Parser(sl_command, "P2IS-PS1", command_data.Dialogue, 4, 225);
        ...
        public Bitmap Set_Bustup_Placement(UserInfoFields account, Bitmap bustup, BustupData bustup_data)
        {
            ...
            using (Graphics graphics = Graphics.FromImage(base_template))
            {
                if (account.P2IS_PSX_TS_Invert == "On")
                {
                    bustup = Invert_Bitmap(bustup);
                }

                if (account.P2IS_PSX_TS_Sprite_Flip == "On")
                {
                    bustup.RotateFlip(RotateFlipType.Rotate180FlipY);
                }

                switch (account.P2IS_PSX_TS_Position)
                {
                    case "Default":
                        switch (bustup_data.P2IS_PSX_Default_Position)
                        {
                            case "Left":
                                graphics.DrawImage(bustup, bustup_data.P2IS_PSX_Left_Coord_X, bustup_data.P2IS_PSX_Left_Coord_Y, bustup_data.P2IS_PSX_Scale_Width, bustup_data.P2IS_PSX_Scale_Height);
                                break;

                            case "Right":
                                graphics.DrawImage(bustup, bustup_data.P2IS_PSX_Right_Coord_X, bustup_data.P2IS_PSX_Right_Coord_Y, bustup_data.P2IS_PSX_Scale_Width, bustup_data.P2IS_PSX_Scale_Height);
                                break;
                        }
                        break;
        ...
        {
            Bitmap base_template = new Bitmap(template_width, template_height);
            Bitmap window_frame = (Bitmap)System.Drawing.Image.FromFile($@"{AssetDirectoryConfig.assetDirectory.assetFolderPath}//SceneMaker//Templates//P2IS-PS1//frame.png");
            Bitmap wallpaper = new Bitmap(template_width, template_height);

            switch (account.P2IS_PSX_TS_Wallpaper)
            {
                case "Blue Tone":
                    wallpaper = (Bitmap)System.Drawing.Image.FromFile($@"{AssetDirectoryConfig.assetDirectory.assetFolderPath}//SceneMaker//Templates//P2IS-PS1//Wallpaper//1.png");
                    break;

                case "Sepia Tone":
                    wallpaper = (Bitmap)System.Drawing.Image.FromFile($@"{AssetDirectoryConfig.assetDirectory.assetFolderPath}//SceneMaker//Templates//P2IS-PS1//Wallpaper//2.png");
                    break;

                case "Purple Tone":
                    wallpaper = (Bitmap)System.Drawing.Image.FromFile($@"{AssetDirectoryConfig.assetDirectory.assetFolderPath}//SceneMaker//Templates//P2IS-PS1//Wallpaper//3.png");
                    break;

                case "Jack Frost":
                    wallpaper = (Bitmap)System.Drawing.Image.FromFile($@"{AssetDirectoryConfig.assetDirectory.assetFolderPath}//SceneMaker//Templates//P2IS-PS1//Wallpaper//4.png");
                    break;

                case "Star":
                    wallpaper = (Bitmap)System.Drawing.Image.FromFile($@"{AssetDirectoryConfig.assetDirectory.assetFolderPath}//SceneMaker//Templates//P2IS-PS1//Wallpaper//5.png");
                    break;

                case "Punched Metal":
                    wallpaper = (Bitmap)System.Drawing.Image.FromFile($@"{AssetDirectoryConfig.assetDirectory.assetFolderPath}//SceneMaker//Templates//P2IS-PS1//Wallpaper//6.png");
                    break;

                case "Seventh":
                    wallpaper = (Bitmap)System.Drawing.Image.FromFile($@"{AssetDirectoryConfig.assetDirectory.assetFolderPath}//SceneMaker//Templates//P2IS-PS1//Wallpaper//7.png");
                    break;

                case "Cuss High":
                    wallpaper = (Bitmap)System.Drawing.Image.FromFile($@"{AssetDirectoryConfig.assetDirectory.assetFolderPath}//SceneMaker//Templates//P2IS-PS1//Wallpaper//8.png");
                    break;

                case "Butterfly":
                    wallpaper = (Bitmap)System.Drawing.Image.FromFile($@"{AssetDirectoryConfig.assetDirectory.assetFolderPath}//SceneMaker//Templates//P2IS-PS1//Wallpaper//9.png");
                    break;

                case "Grid":
                    wallpaper = (Bitmap)System.Drawing.Image.FromFile($@"{AssetDirectoryConfig.assetDirectory.assetFolderPath}//SceneMaker//Templates//P2IS-PS1//Wallpaper//10.png");
                    break;
            }
        ...
        public Bitmap Render_Name(string display_name)
        {
            ...
            for (int i = 0; i < char_array.Length; i++)
            {
                ...
                var glyph = ParsingMethods.Get_P2IS_PS1_Glyph(char_array[i]);
        ...
        public Bitmap Render_Dialogue(List<string>[] dialogue_lines, bool system_message_check)
        {
            ...
            for (int i = 0; i < dialogue_lines.Length; i++)
            {
                ...
                {
                    //Retrieve glyph information from the JSON file
                    var glyph = ParsingMethods.Get_P2IS_PS1_Glyph(char_array[j]);
        ...
        public Bitmap Render_Cursor()
        {
            ...
            Bitmap cursor = (Bitmap)System.Drawing.Image.FromFile($@"{AssetDirectoryConfig.assetDirectory.assetFolderPath}//SceneMaker//Templates//P2IS-PS1//Cursor//{cursor_frame}.png");
        ...
        public Bitmap Scale_Template(UserInfoFields account, Bitmap input_template)
        {
            ...
            if (account.P2IS_PSX_Resolution == "320 × 240")
            {
                // Do nothing if setting is at default resolution
            }
            else
            {
                if (account.P2IS_PSX_Resolution == "1440 × 1080")
                {
                    scaled_width = 1440;
                    scaled_height = 1080;
                }
        ...
        public EmbedBuilder P2IS_PS1_Loading_Message()
        {
            ...
            embed.WithThumbnailUrl(EmbedSettings.Get_Loading_Icon("P2IS-PS1", null));
