...
namespace SocialLinker.Core.SceneMaker.TemplateRenders.QuickScenes
{
    public class RenderP4_PS2
    {
        ...
        public async Task Render_Quick_Scene_P4_PS2(SocialLinkerCommand sl_command)
        {
            ...
            using (Graphics graphics = Graphics.FromImage(base_template))
            {
                ...
                maker_command_data.Dialogue = OfficialSetMethods.Validate_Input(sl_command, "P4-PS2", "Dialogue", maker_command_data.Dialogue);
                List<string>[] parsed_lines = OfficialSetMethods.Line_Parser(sl_command, "P4-PS2", maker_command_data.Dialogue, 3, max_line_length);
