...
namespace SocialLinker.Core.SceneMaker.TemplateRenders.MakerMulti
{
    public class RenderP3P
    {
        ...
        public async Task Render_Quick_Scene_P3P(SocialLinkerCommand sl_command)
        {
            ...
            sl_command.MakerCommand.Character_Data.Bustup_Data = BustupDataMethods.Get_Bustup_Data(account, set_data, maker_multi_command_data);
            ...
            {
                bustup_1 = OfficialSetMethods.Bustup_Selection(sl_command, account, set_data, bustup_data);
            }
            ...
            using (Graphics graphics = Graphics.FromImage(base_template))
            {
                ...
                if (maker_multi_command_data.Character_Data_1.Base_Sprite != 0)
                {
                    Bitmap placed_bustup = Set_Bustup_Placement(account, bustup_1, bustup_data, set_data);
            ...
            using (Graphics graphics = Graphics.FromImage(base_template))
            {
                ...
                string display_name = OfficialSetMethods.GetDisplayName(account, maker_multi_command_data);
