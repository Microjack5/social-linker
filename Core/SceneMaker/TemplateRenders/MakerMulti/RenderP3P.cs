    ...
    public class RenderP3P
    {
        ...
        public async Task Render_Quick_Scene_P3P(SocialLinkerCommand sl_command)
        {
            try
            {
                ...
                MakerMultiCommandData maker_multi_command_data = sl_command.MakerMultiCommand;
                ...
                OfficialSetData set_data_1 = sl_command.MakerMultiCommand.Character_Data_1.Set_Data;
                OfficialSetData set_data_2 = sl_command.MakerMultiCommand.Character_Data_2.Set_Data;

                sl_command.MakerMultiCommand.Character_Data_1.Bustup_Data = BustupDataMethods.Get_Bustup_Data(account, set_data_1, maker_multi_command_data.Character_Data_1);
                sl_command.MakerMultiCommand.Character_Data_2.Bustup_Data = BustupDataMethods.Get_Bustup_Data(account, set_data_2, maker_multi_command_data.Character_Data_2);
                BustupData bustup_data_1 = sl_command.MakerMultiCommand.Character_Data_1.Bustup_Data;
                BustupData bustup_data_2 = sl_command.MakerMultiCommand.Character_Data_2.Bustup_Data;
                ...
                // Convert
                sl_command.MakerCommand.Background = sl_command.MakerMultiCommand.Background;
                sl_command.MakerCommand.Display_Name_Has_Invalid_Char = sl_command.MakerMultiCommand.Display_Name_Has_Invalid_Char;
                sl_command.MakerCommand.Dialogue_Has_Invalid_Char = sl_command.MakerMultiCommand.Dialogue_Has_Invalid_Char;
                ...
                if (maker_multi_command_data.Character_Data_1.Base_Sprite != 0)
                {
                    bustup_1 = OfficialSetMethods.Bustup_Selection(sl_command, account, maker_multi_command_data.Character_Data_1);
                }

                if (maker_multi_command_data.Character_Data_2.Base_Sprite != 0)
                {
                    bustup_2 = OfficialSetMethods.Bustup_Selection(sl_command, account, maker_multi_command_data.Character_Data_2);
                }
                ...
                using (Graphics graphics = Graphics.FromImage(base_template))
                {
                    ...
                    string display_name = "Placeholder"; //OfficialSetMethods.GetDisplayName(account, maker_multi_command_data);
                    ...
                    maker_multi_command_data.Dialogue = OfficialSetMethods.Validate_Input(sl_command, "P3P", "Dialogue", maker_multi_command_data.Dialogue);
                    List<string>[] parsed_lines = OfficialSetMethods.Line_Parser(sl_command, "P3P", maker_multi_command_data.Dialogue, 3, max_line_length);
