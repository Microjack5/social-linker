...
{
    public class RenderMultiCharP3P
    {
        ...
        public async Task Render_Multi_Character_Scene_P3P(SocialLinkerCommand sl_command)
        {
            ...
            using (Graphics graphics = Graphics.FromImage(base_template))
            {
                ...
                if (maker_command_data.Character_Data_1.Base_Sprite != 0)
                {
                    Bitmap placed_bustup = Set_Bustup_Placement(account, bustup_1, bustup_data_1, 1);
                    graphics.DrawImage(placed_bustup, 0, 0, template_width, template_height);
                }
                //Bustup 2
                if (maker_command_data.Character_Data_2.Base_Sprite != 0)
                {
                    Bitmap placed_bustup = Set_Bustup_Placement(account, bustup_2, bustup_data_2, 2);
                    graphics.DrawImage(placed_bustup, 0, 0, template_width, template_height);
                }
        ...
        public Bitmap Set_Bustup_Placement(UserInfoFields account, Bitmap bustup, BustupData bustup_data, int char_number)
        {
